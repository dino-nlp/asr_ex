...
def has_devices(devices: Union[List[str], str]):
    ...
    Args:
        devices (Union[List[str], str]): list of devices or a device

    Returns:
        _type_: True if devices are available, False otherwise
    
    Examples: has_devices(["GPU:0", "GPU:1"]) or has_devices("GPU:0")
    """
